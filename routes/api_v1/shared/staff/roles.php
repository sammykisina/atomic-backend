...
Route::middleware(['auth:sanctum', 'ability:read-roles,create-roles,edit-roles,delete-roles,assign-roles, revoke-roles, create-permissions, revoke-permissions,revoke-ability'])->group(function (): void {
