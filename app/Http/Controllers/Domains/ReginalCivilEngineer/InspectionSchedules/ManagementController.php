...
use Domains\ReginalCivilEngineer\Mails\InspectionScheduleMail;
use Domains\ReginalCivilEngineer\Models\InspectionSchedule;
use Domains\ReginalCivilEngineer\Notifications\InspectionScheduleNotification;
use Domains\ReginalCivilEngineer\Requests\CreateInspectionSchedulesRequest;
use Domains\ReginalCivilEngineer\Requests\EditInspectionScheduleRequest;
use Domains\ReginalCivilEngineer\Services\InspectionScheduleService;
    ...
    public function create(CreateInspectionSchedulesRequest $request): HttpException | Response
    {
        $inspection_schedules_created = DB::transaction(function () use ($request): bool {
            foreach ($request->validated(key: 'inspection_schedules') as $key => $inspection_schedule) {
                ...
                $inspection_schedule->inspector->notify(
                    new InspectionScheduleNotification(
                        type: NotificationTypes::INSPECTION_SCHEDULE_CREATED,
                        inspectionSchedule: $inspection_schedule,
                    ),
                );
